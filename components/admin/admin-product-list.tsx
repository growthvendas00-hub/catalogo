...
export function AdminProductList({ products }: { products: Product[] }) {
  ...
  return <>
    ...
    <div className={pending ? "pointer-events-none opacity-60" : ""}>
      <div className="hidden grid-cols-[4.5rem_minmax(12rem,1fr)_9rem_7rem_6rem_10rem] gap-4 border-y fine-rule px-4 py-3 text-[.62rem] font-bold tracking-[.1em] text-[var(--muted)] uppercase xl:grid"><span>Imagem</span><span>Peça</span><span>Categoria</span><span>Preço</span><span>Posição</span><span>Ações</span></div>
