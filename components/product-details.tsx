...
export function ProductDetails({ product, settings, demoMode }: { product: Product; settings: CatalogSettings; demoMode: boolean }) {
  ...
  return (
    <div className="px-[var(--page-gutter)] py-8 sm:py-12 lg:sticky lg:top-0 lg:max-h-screen lg:overflow-y-auto">
      <p className="eyebrow text-black/50">{product.category}</p>
