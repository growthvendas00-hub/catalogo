...
export function BrandMark({ logoUrl, compact = false, brandName = "Laus Sit" }: { logoUrl?: string | null; compact?: boolean; brandName?: string }) {
  if (logoUrl) {
    return <Image src={logoUrl} alt={brandName} title={brandName} width={compact ? 98 : 150} height={compact ? 48 : 72} className="h-auto w-auto object-contain" priority />;
  }
